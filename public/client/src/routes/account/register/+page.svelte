...
<div class="flex h-screen w-full items-center justify-center bg-gray-100 dark:bg-gray-900">
	...
	>
		<h1
			class="lg:my-7 my-5 w-full text-center font-['Roboto_Slab',sans_serif] lg:text-4xl md:text-3xl text-3xl font-bold text-indigo-900 dark:text-indigo-100"
		>
			Sign Up
		</h1>
        ...
        <div class="m-3 mt-7 flex">
		    <button class="flex-1 p-2 rounded bg-indigo-500 dark:bg-indigo-600 text-white cursor-pointer hover:bg-indigo-600 dark:hover:bg-indigo-700 transition">Sign Up</button>
        </div>
		<div class="text-center">
			<p class="text-sm dark:text-gray-300">Already have an account? <a href={resolve('/account/login')} class="text-indigo-600 dark:text-indigo-500 underline">Sign up</a></p>
		</div>
	</form>
</div>
